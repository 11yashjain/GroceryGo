...
import 'package:Grocery_App/GroceryApp/Cart/Ui/Cart.dart';
                        ...
                        children: [
                          TabBar(
                            ...
                            tabs: [
                              Tab(
                                  icon: Image.network(
                                'https://img.icons8.com/?size=160&id=tgmqacLfjsi4&format=png',
                                scale: 2.7,
                              )),
                              Tab(
                                  icon: Image.network(
                                'https://img.icons8.com/?size=160&id=eiswqWDOM6o2&format=png',
                                scale: 2.7,
                              )),
                              Tab(
                                  icon: Image.network(
                                'https://img.icons8.com/?size=160&id=BN4swBtH71wy&format=png',
                                scale: 3.0,
                              )),
                              Tab(
                                  icon: Image.network(
                                'https://cdn-icons-png.flaticon.com/128/10473/10473353.png',
                                scale: 3.0,
                              )),
                            ],
                          ),
                          Expanded(
                            child: TabBarView(
                              children: [
                                AllItems(homeBloc: HomeBloc()),
                                Beauty(),
                                Fruitsandvegetables(homeBloc: HomeBloc()),
                                Technology(),
                              ],
                            ),
                          ),
